...
const scrollLogo = () => {
    ...
    if (scrollY >= 50) {
        logo.src = './assets/img/logo-starclean-change.svg'
    } else {
        logo.src = './assets/img/logo-starclean.svg'
    }
}
...
const scrollUp = () =>{
    ...
    // Quando a rolagem for maior que 350 de altura da janela de visualização, adicione a classe show-scroll á tag com a classe scrollup
...
// Tópico selecionado anteriormente se  usuário tiver selecionado
